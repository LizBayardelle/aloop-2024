class ProductsController < ApplicationController
  ...
  def show
    ...
    @product_json = ActiveModelSerializers::SerializableResource.new(
      @product, 
      serializer: ProductSerializer,
      include: ['components', 'components.variants']
    ).to_json
  end
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        ...
        Variant.create(component_id: default_component.id, name: "Default")
